...
Source Database       : zc_1542

Target Server Type    : MYSQL
Target Server Version : 50508
File Encoding         : 65001

Date: 2015-06-13 11:19:34
*/
...
-- ----------------------------
INSERT INTO `%DB_PREFIX%admin` VALUES ('1', 'admin', '21232f297a57a5a743894a0e4a801fc3', '1', '0', '4', '1434136365', '127.0.0.1');
...
) ENGINE=MyISAM AUTO_INCREMENT=289 DEFAULT CHARSET=utf8 COMMENT='// 配置';
...
INSERT INTO `%DB_PREFIX%conf` VALUES ('6', '', '1.542', '0', '0', '', '1', '0', '0');
...
CREATE TABLE `%DB_PREFIX%log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2406 DEFAULT CHARSET=utf8 COMMENT='//记录';
