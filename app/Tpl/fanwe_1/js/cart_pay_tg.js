...
function show_pay_tip()
{
	var html =  '<div class="pay_tip_box">'+
				...
				'	<div class="tc">'+
				'		<div class="ui-center-button theme_bgcolor" id="check_payment" rel="green" style="width:100px">'+
				'			<div>'+
				'				<span>支付成功</span>'+
				'			</div>'+
				'		</div>'+
				'		<div class="ui-center-button bg_red" id="choose_payment" rel="blue" style="margin-left:5px;width:130px">'+
				'			<div>'+
				'				<span>支付遇到问题</span>'+
				'			</div>'+
				'		</div>'+
