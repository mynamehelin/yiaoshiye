...
function show_pay_tip()
{
	...
	var dealId = $(".infoId").val();
	var sunMoney =$(".sunMoney").val();
	var dealInfo = $(".dealInfo").val();
	var userName = $(".userName").val();
	var userid = $(".userid").val();
	var money = sunMoney.replace(/,/g,"");
	var userMobile = $(".mobile").val();
	$.post("/pay/saveSharing.php",{"userid":userid,"dealId":dealId,"sunMoney":money,"dealInfo":dealInfo,"userName":userName,"userMobile":userMobile},function(data){});
