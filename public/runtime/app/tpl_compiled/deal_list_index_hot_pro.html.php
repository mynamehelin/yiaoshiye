...
?>	
<div class="nav_item nav_item2<?php if ($this->_foreach['deal_item_hot_pro']['iteration'] % 4 == 1): ?> first<?php endif; ?>" onclick="window.open('<?php
...
?><?php endif; ?>" alt="<?php echo $this->_var['deal_hot_pro_items']['name']; ?>" lazy="true" />
			<?php if ($this->_var['deal_hot_pro_items']['type'] == 0): ?>
				...
				<span <?php if ($this->_var['deal_hot_pro_items']['percent'] >= 100): ?>class="project_step project_success"<?php else: ?>class="project_step project_fail"<?php endif; ?>><?php if ($this->_var['deal_hot_pro_items']['percent'] >= 100): ?>出售中<?php else: ?>筹资失败<?php endif; ?></span> 	 
				<?php else: ?>
					<?php if ($this->_var['deal_hot_pro_items']['percent'] >= 100): ?>
						<span class="project_step project_success">出售中</span>
					<?php else: ?>
