...
if (isset($read_modules) && $read_modules == true)
{
    ...
    /* 名称 */
    $module['name']    = "短信宝 (<a href='http://www.smsbao.com/reg?r=10022' target='_blank'><font color='red'>还没账号？点击这免费注册</font></a>)";
...
class smsbao_sms implements sms
{
  ...
  public function __construct($smsInfo = '')
	...
	public function check_fee()
	{
    	...
    	{
    			$str = "短信宝 (<a href='http://www.smsbao.com/reg?r=1002' target='_blank'><font color='red'>还没账号？点击这免费注册</font></a>)";
    	}
		...
		else
		{
			...
			return "短信宝 (<a href='http://www.smsbao.com/reg?r=1002' target='_blank'><font color='red'>还没账号？点击这免费注册</font></a>)";
		}
